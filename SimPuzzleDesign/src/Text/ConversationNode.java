...
public class ConversationNode implements Comparable<ConversationNode>, Serializable{
	...
	public List<Text> getCurrentConversationText(){
		List<Text> currentConversation = new ArrayList<Text>();
		
		currentConversation.add(getData());
		for(ConversationNode children : getChildren())
